...
//    }
    ...
    public String uploadImage(MultipartFile image) {
        ...
        System.out.println("서비스단 uploadImage메서드 시작");
        String apiUrl = "https://api.imgbb.com/1/upload";
        ...
        System.out.println("멀티벨류 맵 바디");
        MultiValueMap<String, Object> body = new LinkedMultiValueMap<>();
        body.add("image", image.getResource());
        System.out.println("바디에 apiKey넣자");
        body.add("key", apiKey);

        System.out.println("requestEntity 만들자");
        HttpEntity<MultiValueMap<String, Object>> requestEntity = new HttpEntity<>(body, headers);
        System.out.println("requestEntity===="+ requestEntity);

        System.out.println("이미지url 만들자");
        String imageUrl = restTemplate.exchange(apiUrl, HttpMethod.POST, requestEntity, String.class).getBody();
        System.out.println("========================================================");
